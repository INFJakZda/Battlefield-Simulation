...
public class ReLogoObserver extends BaseObserver{
	...
	/**
	 * Makes a number of randomly oriented riders and then executes a set of commands on the
	 * created riders.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<battle.relogo.Rider> createRiders(int number, Closure closure) {
		AgentSet<battle.relogo.Rider> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Rider");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("battle.relogo.Rider")
	public AgentSet<battle.relogo.Rider> createRiders(int number) {
		return createRiders(number,null);
	}

	/**
	 * Makes a number of uniformly fanned riders and then executes a set of commands on the
	 * created riders.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("battle.relogo.Rider")
	public AgentSet<battle.relogo.Rider> createOrderedRiders(int number, Closure closure) {
		AgentSet<battle.relogo.Rider> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Rider");
		for (Turtle t : createResult){
			if (t instanceof battle.relogo.Rider){
				result.add((battle.relogo.Rider)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("battle.relogo.Rider")
	public AgentSet<battle.relogo.Rider> createOrderedRiders(int number) {
		return createOrderedRiders(number,null);
	}
	...
	public AgentSet<battle.relogo.Rider> riders(){
		...
		for (Object e : this.getContext().getObjects(battle.relogo.Rider.class)) {
	...
	public AgentSet<battle.relogo.Rider> ridersOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"rider")){
			if (t instanceof battle.relogo.Rider)
			result.add((battle.relogo.Rider)t);
		}
		return result;
	...
	public AgentSet<battle.relogo.Rider> ridersOn(Turtle t){
		AgentSet<battle.relogo.Rider> result = new AgentSet<battle.relogo.Rider>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"rider")){
	...
	/**
	 * Makes a number of randomly oriented soldiers and then executes a set of commands on the
	 * created soldiers.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<battle.relogo.Soldier> createSoldiers(int number, Closure closure) {
		AgentSet<battle.relogo.Soldier> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Soldier");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("battle.relogo.Soldier")
	public AgentSet<battle.relogo.Soldier> createSoldiers(int number) {
		return createSoldiers(number,null);
	}

	/**
	 * Makes a number of uniformly fanned soldiers and then executes a set of commands on the
	 * created soldiers.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("battle.relogo.Soldier")
	public AgentSet<battle.relogo.Soldier> createOrderedSoldiers(int number, Closure closure) {
		AgentSet<battle.relogo.Soldier> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Soldier");
		for (Turtle t : createResult){
			if (t instanceof battle.relogo.Soldier){
				result.add((battle.relogo.Soldier)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("battle.relogo.Soldier")
	public AgentSet<battle.relogo.Soldier> createOrderedSoldiers(int number) {
		return createOrderedSoldiers(number,null);
	}
	...
	public AgentSet<battle.relogo.Soldier> soldiers(){
		...
		for (Object e : this.getContext().getObjects(battle.relogo.Soldier.class)) {
	...
	public AgentSet<battle.relogo.Soldier> soldiersOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"soldier")){
			if (t instanceof battle.relogo.Soldier)
			result.add((battle.relogo.Soldier)t);
		}
		return result;
	...
	public AgentSet<battle.relogo.Soldier> soldiersOn(Turtle t){
		AgentSet<battle.relogo.Soldier> result = new AgentSet<battle.relogo.Soldier>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"soldier")){
